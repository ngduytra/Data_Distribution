...
class ShowDetailLabelData extends React.Component {
  state = { 
    visible: false,
    idFileMongo: "",
   };
    ...
    <div>
      ...
      >
        <Descriptions title="Information" column={1} bordered={true} layout='horizontal'>
          <Descriptions.Item label="Renter">{infor.user.nickName}</Descriptions.Item>
          <Descriptions.Item label="Description">{infor.IPFS.description}</Descriptions.Item>
          <Descriptions.Item label="Hunting File">
...
export default connect(mapStateToProps, mapDispatchToProps)(ShowDetailLabelData);