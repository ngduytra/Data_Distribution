...
class InfoLabelFile extends React.Component {
  render() {
  ...
  <Card
    ...
    >
      ...
      <Button  style={{textAlign: 'center', padding: 0, fontSize: 14, height: 20, width:'100%' ,overflow: 'hidden'}}  type="link" onClick={()=> this.props.history.push(`/data/${record.music._id}`)}>{record.music.name}</Button>
...
export default withRouter(InfoLabelFile)
