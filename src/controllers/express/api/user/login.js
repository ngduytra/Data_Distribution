...
module.exports = (req, res) => {
    ...
    .then(result => {
        ...
        let {refreshToken, id, email, addressEthereum, userName, avatar, isAdmin} = userData;
        if(!isMatchPassword){
            return Promise.reject("Password not match")
        }
        lib_common.getBalance(addressEthereum).then( balance => {
            response_express.success(res, {isAdmin, accessToken, refreshToken, avatar, id, email, userName, addressEthereum, HAK: balance.HAK})
